...
def plot(plt, title, names, data, output_path, max_xlim, xstep, min_ylim,
    ...
    plt.set_title(title, fontsize=font_size, y=-0.47, fontweight="bold")
    plt.tick_params(
        axis="both",
        which="major",
        labelsize=font_size,
...
if __name__ == "__main__":
    ...
    font_size = 20
    tick_space_len = 1
    # draw_figure(plt.subplot(2, 2, 1), "PD-GAT-2layer",
    #             "data/accuracy_time_gat_products_2layer.csv",
    #             "figures/accuracy_time_gat_products_2layer.pdf", 140, 70, 0, 1,
    #             0.5, True, True, 0.5, 0.9, 0.7, 87, 0.55, 0.783)
    draw_figure(plt.subplot(1, 2, 1), "PD-GAT-3layer",
    ...
    print(f"[Note]Save to figures/accuracy_time_depth_gat_products.pdf")
    plt.savefig("figures/accuracy_time_depth_gat_products.pdf",
                bbox_inches="tight")
    plt.close("all")
